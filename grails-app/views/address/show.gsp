    ...
    <body>
        ...
        <div id="show-address" class="content scaffold-show" role="main">
            ...
            <fieldset class="form view-only">
                <g:hiddenField name="patient.id" value="${params.patient}" />
                <g:render template="form" />
            </fieldset>
            <g:form resource="${this.address}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="btn btn-info" action="edit" resource="${this.address}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

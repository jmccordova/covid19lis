		...
		<div class="card">
		    ...
		    <div class="card-body">
		        <div class="form-group">
					...
					<g:select name="addressType" id="addressType" class="form-control" value="${addressInstance?.addressType}" from="${ph.edu.upm.nih.AddressType}"optionKey="key" noSelection="['':'Select Type of Address']" />
		        </div>
		        <div class="row">
		        	<div class="col-sm-2">
				        <div class="form-group">

...
<html>
    ...
    <body>
        ...
        <div id="show-staff" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.staffInstance}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.staffInstance}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
